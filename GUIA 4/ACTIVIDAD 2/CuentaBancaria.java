...
public class CuentaBancaria {
    ...
    public void retirar(double monto) throws SaldoInsuficienteException {
        ...
        if (monto > saldo) throw new SaldoInsuficienteException("Fondos insuficientes. Saldo: " + saldo);
        saldo -= monto;
    ...
    public void transferir(CuentaBancaria destino, double monto) throws SaldoInsuficienteException {
        ...
        this.retirar(monto);  // lanza SaldoInsuficienteException si no hay fondos
    ...
    public List<String> getHistorial() throws HistorialVacioException {
        if (historial.isEmpty()) throw new HistorialVacioException("No hay movimientos en esta cuenta.");
        return historial;
    }
    @Override
